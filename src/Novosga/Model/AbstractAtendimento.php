...
abstract class AbstractAtendimento extends SequencialModel
{
	...
	/*NUEVOS*/
	 ...
	 /**
     * @Column(type="integer", name="estado_pausado", nullable=true)
     */
    protected $estadoPausado;
	...
	/*NUEVOS*/
	    public function getEstadopausado()
    {
        return $this->estadoPausado;
    }

    public function setEstadopausado($estadoPausado)
    {
        $this->estadoPausado = $estadoPausado;
